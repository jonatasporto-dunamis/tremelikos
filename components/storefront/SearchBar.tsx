...
<button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-gray-100 text-ink-muted hover:bg-gray-200 flex items-center justify-center"
            >
